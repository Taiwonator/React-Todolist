...
const Widgets = (props) => (
    <div className='widgets'>
        ...
        <ArrowButtons goToToday={props.goToToday} classStates={props.classStates} backDay={props.backDay} forwardDay={props.forwardDay} backMonth={props.backMonth} forwardMonth={props.forwardMonth}/>
